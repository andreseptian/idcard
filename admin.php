...
$retrieve = mysqli_query($db,$sqluse);
 ...
 <div id="Taxreceipted" class="modal fade" role="dialog">
  ...
  <div class="input-group">
    <span class="input-group-addon">id dimulai @</span>
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background:#222d32">
        ...
        <h4 class="modal-title" style="font-family: Times New Roman;color:#F0F0F0;"><center>
                   Edit data dari <input style="border: none;background:#222d32" type="text" id="oldname" value="" readonly="readonly" />
        ...
        <center>
        	...
        	<form method="post" action="upload.php" enctype='multipart/form-data'>        		
        		...
        		<p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Department:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="minstitution"  id='cc'></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;Email Add:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="memail" id='dd'></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Position Job:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="mrank" id='bb'></span></p>
        	     <p ><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;Staff No ID:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="mid" id='oldpass'></span></p>
        		Tambah foto profil:<input name='filed' type='file' id='filed' >
      ...
      <div class="modal-footer">
        <input type="submit" class="btn btn-success" value="Perbarui" id="amendreceipt" name="resetpass"> &nbsp;
 ...
 <div id="Useradd" class="modal fade" role="dialog">
      ...
      <div class="modal-body" >       	
      	<center> 
        		...
        		<p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Department:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="minstitution"></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Position:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="memail"></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;Email Add:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="mphone"></span></p>
        		...
        		Tambah foto profil (Disarankan resolusi 170:135):<input name='filed' type='file' id='filed' >
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      ...
      <div class="modal-body" >       	
      	<center> 
            <p style="color:red">Jika informasi sistem sudah ada jangan menambahnya lagi lakukan edit informasi sistem !</p>
        		...
        		<p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;Email:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="orgemail"></span></p>
        	     ...
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Active Year:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="orgyear"></span></p>
        	        Attach Organisation Logo:(<h7 style="color:red">Disarankan gambar transparan / png</h7>)<input name='filed' type='file' id='filed' >
                                   	 <input type="hidden" name="page" value="admin.php"/>                                                        	      		
         </center>
      </div>
      <div class="modal-footer">
        <input type="submit" class="btn btn-success" value="Simpan" id="addmember" name="orginitial"> &nbsp;
        <button type="button" class="btn btn-success" data-dismiss="modal">Tutup</button>
      </div>
      </div>
       </form>
 ...
 <div id="Initialisation2" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      ...
      <div class="modal-footer">
        <input type="submit" class="btn btn-success" value="Perbarui" id="addmember" name="orgupdate"> &nbsp;
        <button type="button" class="btn btn-success" data-dismiss="modal">Tutup</button>
      </div>
      </div>
       </form>
...
<?php   
				$sqln ="SELECT * FROM Inorg ";
                   ...
                   if($numb!=0){
                            while($foundl = mysqli_fetch_array($rgetb))
										...
										echo"<center><a href='http://blogbugabagi.blogspot.com' target='_blank' rel='noopener noreferrer'><img src='media/$profile'  width='70%' height='140px' alt=''></a></center>";	   
                               }
							else{
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                <a href="admin.php">
                <i class="fa fa-tv"></i> <span>Kontrol Data</span>
                </a>
              </li>
               <li class="treeview">
                <a href="#">
                <i class="fa fa-cog"></i>
                <span>Pengaturan Informasi</span>
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a data-toggle='modal' data-id='' href='#Initialisation2' class='open-Initial2'><i class="fa fa-minus"></i>Edit Info Sistem</a></li>
                </ul>
              </li>
                            
              <li class="treeview">
                  <a data-toggle='modal' data-id='' href='#Useradd' class='open-adduser'><i class="fa fa-user"></i>Tambah Staff</a>
         
              </li>
              <li class="treeview">
              	  <a  href="bulk.php" ><i class='fa fa-print'></i>Pendaftaran CSV </a>
               </li>
              <li class="treeview">
              	  <a data-toggle='modal' href="#Taxreceipted" class="Open-Taxreceipted"><i class='fa fa-print'></i>Print ID Card</a>
               </li>
					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								 <li>
                                  <a data-toggle='modal' data-id='<?php echo$id; ?>' href='#Updatepicture' class='open-Updatepicture'><i class="fa fa-user"></i>Ubah foto profil</a>
                                 </li>
		...
		<div id="page-wrapper"  >
			...
			<div class="mid-content-top charts-grids">
				...
				<div class="alert alert-info">
                             <i class="fa fa-envelope"></i>&nbsp;Gunakan kolom pencarian dalam mencari data
                         </div>
	...
	<!--footer-->
	<div class="footer">
	  <p>© All Rights Reserved | <a href="http://blogbugabagi.blogspot.com" target="_blank" rel="noopener noreferrer"><?= $name; ?></a>
