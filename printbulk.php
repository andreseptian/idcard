...
#id::before {
  ...
  width: 100%;
  height: 100%;
  background: url('images/bkg-4.jpg');
	...
	while($foundk = mysqli_fetch_array($retrieve))
	                                     {
										     ...
										     $sqlid ="SELECT * FROM Inorg Order BY id DESC";
      ...
      <div id="bg">
        ...
        <tr> <td><?php  if($numb!=0 ){
                                    if($profile!=""){echo"<img src='media/$imgpr'  width='70px' height='70px' alt=''>";}
										 ...
										 echo"<img src='images/$imgpr' alt='Avatar'  width='70px' height='70px'>";
									    }	   
                               }else{
			?>
        	<img src=<?php echo "media/$imgpr" ?> alt="Avatar"  width="70px" height="70px"> <?php }?>
        	</td>
        <td><h3 style="color:white"><b><?= $idsx;?></b></h3></td>
       </tr>        
    </table>    
				<center>
        <?php  
        ...
        <p style="font-weight: bold;margin-top:-4%"><?php if(isset($pass)){ echo$pass;} ?></p>
      	...
      	<p style="margin-top:-4%">HOLDER SIGNATURE</p>
            ...
            <div class="id-1">
                     	 ...
                     	 <center><img src=<?="media/$imgpr"?> alt="Avatar" width="200px" height="175px" >        
       <div class="container" align="center">
