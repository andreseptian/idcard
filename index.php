...
include_once("db_connect.php");
   ...
   $sqlid ="SELECT * FROM Inorg Order BY id=1";
...
<body class="" style="background-image:url(images/body.png)">
<div role="navigation" class="navbar navbar-default navbar-static-top">
	...
	<form class="form-login" method="post" id="login-form">
		<h2 class="form-login-heading">Masuk Disini</h2><hr />
		<div id="error">
		</div>
		<div class="form-group">
			<input type="email" class="form-control" placeholder="Alamat email" name="user_email" id="user_email" />
