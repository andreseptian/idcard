...
#id::before {
  ...
  width: 100%;
  height: 100%;
  background: url('images/bkg-2.jpg');   /*if you want to change the background image replace logo.png*/
...
?>
	<body>
	<?php   $sqlid ="SELECT * FROM Inorg Order BY id DESC";
 	...
 	window.print();
      ...
      <div id="bg">
        ...
        <tr> <td>
        	<?php if($numb!=0 ){
                                    if($profile!=""){echo"<img src='media/$imgpr'  width='70px' height='70px' alt=''>";}
									else{
										 echo"<img src='media/$imgpr' alt='Avatar'  width='70px' height='70px'>";
									    }	   
                               }else{
			?>
        	<img src=<?php echo "media/$imgpr" ?> alt="Avatar"  width="70px" height="70px"> <?php }?>
        	</td><?php   $sqlid ="SELECT * FROM Inorg Order BY id DESC";
			       $ret = mysqli_query($db,$sqlid);				                
                     while($found = mysqli_fetch_array($ret))
	                 {
					   $idsx=$found['name'];
        ...
        <td><h3 style="color:white;"><b><?php echo $idsx; ?></b></h3></td>
       </tr>        
    </table><center>
        <?php  
     $idx = $_GET['id'];
      $sqlmember ="SELECT * FROM Users WHERE id='$idx' ";
			       $retrieve = mysqli_query($db,$sqlmember);
                     ...
                     while($found = mysqli_fetch_array($retrieve))
	                 {
             	 	...
             	 	if($profile!=""){          
										   echo"<img src='images/$profile' height='170px' width='135px' alt='' style='border: 2px solid black;'>";	   
									    }
								else{
									echo"<img src='admin/images/profile.jpg' height='170px' width='135px' alt='' style='border: 2px solid black;'>";	   
        ...
        <p style="font-weight: bold;margin-top:-4%"><?php if(isset($pass)){ echo$pass;} ?></p>
      	...
      	<p style="margin-top:-4%">HOLDER SIGNATURE</p>
            ...
            <div class="id-1">
                     	 ...
                     	 <center><img src=<?php echo "media/$imgpr" ?> alt="Avatar" width="200px" height="175px" >        
