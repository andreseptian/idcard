...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
        ...
        <thead>
            <tr>
                <th>Template CSV pendaftaran staff</th>
                             
                <th>&nbsp;</th>
                 
               <?php
            				                                      
		           echo"<th><a href='bulk.php?ids=1'> <i class='fa fa-download'></i>  Unduh</a>&nbsp;</th>";										             			 	
		...
		<div class="charts" >
			<div class="mid-content-top charts-grids">
				...
				<div class="alert alert-success">
                             <i class="fa fa-info-circle"></i>&nbsp;Pastikan bahwa file yang diunggah adalah format csv, selain itu tidak akan diproses.
                              </div>
					<!--//sreen-gallery-cursual---->
			</div>
		</div>
		<div class="charts" >		
			<div class="mid-content-top charts-grids" style="background-color:#00ACED">
				<div class="middle-content" >
						<h4 class="title">
                            <i class="fa fa-info-circle"></i>&nbsp;Panduan Pendaftaran dengan csv

						</h4>
					<!-- start content_slider -->
					     <div class="container">
					     	<ol>
					     		<li>Unduh template file staff csv di pojok kanan atas lalu buku file tersebut</li>
					     		<li>Isikan data para staff di kolom file tersebut dan simpan dalam format csv bukan xls</li>
					     		<li>Unggah file csv tadi ke halaman ini</li>
					     		<li>lalu masukan tanggal masuk di halaman dan tekan impor</li>
					        </ol>
                        </div>
                        Note:&nbsp;<a href='bulk.php?ids=1'><i class="fa fa-envelope"></i></a>&nbsp;File csv yang terunduh silahkan di buka di excel.
        ...
        <form method="post" action="upload.php" enctype='multipart/form-data'>        		
           <p style="margin-bottom:10px;">
               <input id="datepicker-starting-view" type="text" class="form-control" data-zdp_readonly_element="false" placeholder="Pilih tanggal masuk" name="sbd" style='width:255px;'>  
           </p>  
	...
	<!--footer-->
	<div class="footer">
	   <p>  <a href="https://blogbugabagi.blogspot.com" target="_blank">&copy; All Right Reserved </a></p>		
	</div>
    <!--//footer-->
	</div>
